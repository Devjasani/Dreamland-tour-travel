...
<body>
    ...
    <div class="heading" style="background: url('main-image/image-1.jpg') no-repeat;">
    ...
    <section class="packages">
        ...
        <div class="box-container">
            ...
            <?php } ?>
            <!-- if want incraese places than past link hear  -->
